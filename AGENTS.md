...
- **Client logo assets**: the hero **Clients** row pulls marks from `assets/logos/`, `assets/logos/recent-2026/`, and additional named clients in `assets/logos/clients/` (SVG/PNG; prefer SVG for crispness). A short **“and many more”** line under the grid notes the list is not exhaustive.
