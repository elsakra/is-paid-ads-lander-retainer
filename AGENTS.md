...
- **Client logo assets**: the hero **Clients** row pulls marks from `assets/logos/`, `assets/logos/recent-2026/`, and additional named clients in `assets/logos/clients/` (SVG/PNG; prefer SVG for crispness). Copy is inline under the grid clarifying the marks are a sample, not a full client list.
